...
{
    public class RTICycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* RTI */
                /* Implied */   new CycleTruthData(0x40, 6),
            };
        }
        ...
        [Test]
        public void Test_RTI_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();
            
            foreach (var truth in _truthData)
            {
                TestRTI(truth.OpCode);
        ...
        public void TestRTI(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.RTI));
