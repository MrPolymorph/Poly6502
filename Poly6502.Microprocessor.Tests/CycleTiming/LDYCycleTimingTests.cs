...
namespace Poly6502.Microprocessor.Tests.CycleTiming
{
    public class LDYCycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* LDY */
                /* Immediate */   new CycleTruthData(0xA0, 2),
                /* Zero Page */   new CycleTruthData(0xA4, 3),
                /* Zero Page X */ new CycleTruthData(0xB4, 4),
                /* Absolute */    new CycleTruthData(0xAC, 4),
                /* Absolute X */  new CycleTruthData(0xBC, 4, true),
        ...
        [Test]
        public void Test_LDY_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();
            
            foreach (var truth in _truthData)
            {
                TestLDY(truth.OpCode);
        ...
        public void TestLDY(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.LDY));
