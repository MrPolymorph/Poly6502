...
namespace Poly6502.Microprocessor.Tests.CycleTiming
{
    public class NOPCycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* ADC */
                /* Implied */   new CycleTruthData(0xEA, 2),
        ...
        [Test]
        public void Test_NOP_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();
            
            foreach (var truth in _truthData)
            {
                TestNOP(truth.OpCode);
        ...
        public void TestNOP(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.NOP));
