...
namespace Poly6502.Microprocessor.Tests.CycleTiming
{
    public class DECCycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* DEC */
                /* Zero Page */   new CycleTruthData(0xC6, 5),
                /* Zero Page X */ new CycleTruthData(0xD6, 6),
                /* Absolute */    new CycleTruthData(0xCE, 6),
                /* Absolute X */  new CycleTruthData(0xDE, 7),
            };
        }
        ...
        [Test]
        public void Test_DEC_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();

            foreach (var truth in _truthData)
            {
                TestDEC(truth.OpCode);
        ...
        public void TestDEC(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.DEC));
