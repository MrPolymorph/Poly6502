...
namespace Poly6502.Microprocessor.Tests.CycleTiming
{
    public class CPXCycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* ADC */
                /* Immediate */ new CycleTruthData(0xE0, 2),
                /* Zero Page */ new CycleTruthData(0xE4, 3),
                /* Absolute */ new CycleTruthData(0xEC, 4),
            };
        }
        ...
        [Test]
        public void Test_CPX_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();

            foreach (var truth in _truthData)
            {
                TestCPX(truth.OpCode);
        ...
        public void TestCPX(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.CPX));
