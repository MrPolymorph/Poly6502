...
namespace Poly6502.Microprocessor.Tests.CycleTiming
{
    public class RTSCycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* RTS */
                /* Implied */   new CycleTruthData(0x60, 6),
            };
        }
        ...
        [Test]
        public void Test_RTS_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();
            
            foreach (var truth in _truthData)
            {
                TestRTS(truth.OpCode);
        ...
        public void TestRTS(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.RTS));
