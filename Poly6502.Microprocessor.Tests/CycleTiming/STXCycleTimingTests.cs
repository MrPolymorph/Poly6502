...
{
    public class STXCycleTimingTests
    {
        ...
        private void SetupTruthTable()
        {
            ...
            {
                /* STX */
                /* Zero Page */   new CycleTruthData(0x86, 3),
                /* Zero Page Y */ new CycleTruthData(0x96, 4),
                /* Absolute */    new CycleTruthData(0x8E, 4),
        ...
        [Test]
        public void Test_STX_Cycle_Timing()
        {
            StringBuilder sb = new StringBuilder();
            
            foreach (var truth in _truthData)
            {
                TestSTX(truth.OpCode);
        ...
        public void TestSTX(byte opcode)
        {
            Operation op = _m6502.OpCodeLookupTable[opcode];

            Assert.IsTrue(op.OpCodeCompare(_m6502.STX));
